                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="{{ URL::asset('img/'.$usuario->foto) }} ">
            ...
            <div class="modal-content">
                ...
                <form id="form-perfil" method="POST" action="{{route('admin.editar', $id_usuario)}}">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input value="{{$usuario->email}}" type="text" class="form-control" id="email" name="email" placeholder="Email">
                        </div>

                        <div class="form-group">
                            <label>Senha</label>
                            <input value="{{$usuario->senha}}" type="password" class="form-control" id="senha" name="senha" placeholder="Senha">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="col-md-12 form-group">
                            <label>Foto</label>
                            <input value="{{ URL::asset('img/'.$usuario->foto) }}" type="file" class="form-control-file" id="imagem" name="imagem" onchange="carregarImg();">
                        </div>
                        <div class="col-md-12 mb-2">
                            <img src="{{ URL::asset('img/'.$usuario->foto) }}" alt="Carregue sua Imagem" id="target" width="100%">
                        </div>
