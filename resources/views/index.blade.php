...
<body>
    ...
    <img id="logomarca" class="img" src="{{ URL::asset('img/logo1.png') }}">
    ...
    <div class="login">
        ...
        <form action="{{route('usuario.login')}}" method="post">
            ...
            <input type="text" name="usuario" placeholder="nome ou cpf do usuário" required="required" />
            <input type="password" name="senha" placeholder="informação da senha" required="required" />
